...
export const CarDeleteDialog = (props: ICarDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.car.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.car.delete.question" interpolate={{ id: carEntity.id }}>
