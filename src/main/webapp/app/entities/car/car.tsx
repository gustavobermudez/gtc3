...
export const Car = (props: ICarProps) => {
  ...
  return (
    <div>
      <h2 id="car-heading">
        <Translate contentKey="jhipsterSampleApplicationApp.car.home.title">Cars</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterSampleApplicationApp.car.home.createLabel">Create new Car</Translate>
        </Link>
      </h2>
        ...
        {carList && carList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterSampleApplicationApp.car.model">Model</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterSampleApplicationApp.car.home.notFound">No Cars found</Translate>
            </div>
          )
        )}
      </div>
