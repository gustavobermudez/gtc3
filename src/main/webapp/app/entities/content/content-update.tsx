  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.content.home.createOrEditLabel">
            <Translate contentKey="jhipsterSampleApplicationApp.content.home.createOrEditLabel">Create or edit a Content</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
              ...
              <AvGroup>
                <AvGroup>
                  <Label id="dataLabel" for="data">
                    <Translate contentKey="jhipsterSampleApplicationApp.content.data">Data</Translate>
                  </Label>
                  <br />
                  {data ? (
                    <div>
