...
export const DocumentDeleteDialog = (props: IDocumentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.document.delete.question">
        <Translate contentKey="jhipsterSampleApplicationApp.document.delete.question" interpolate={{ id: documentEntity.id }}>
